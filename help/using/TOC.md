...
+ Fonctionnalités {#features}
   ...
   + Modèles algorithmiques {#algorithmic-models}
      ...
      + Audiences prédictives {#predictive-audiences}
         ...
         + [Rapports Predictive Audiences](features/algorithmic-models/predictive-audiences-reporting.md)
   + Audience Lab {#audience-lab}
      ...
      + [Fonctionnalité avancée d’Audience Lab](features/audience-lab/audience-lab-advanced.md)
   ...
   + Explorateur de données {#data-explorer}
      + [Data Explorer - Aperçu, avantages et cas d’utilisation](features/data-explorer/data-explorer-overview.md)
      ...
      + [Renvoi des performances des caractéristiques](features/data-explorer/data-explorer-trait-backfill.md)
   ...
   + Destinations {#destinations}
      ...
      + Destinations basées sur des appareils (serveur à serveur) {#device-based}
         ...
         + [Liste des destinations basées sur des appareils d’Audience Manager](/help/using/features/destinations/device-based-destinations-list.md)
      ...
      + Destinations personnalisées {#custom-destinations}
         ...
         + [Configurer une destination de cookie](features/destinations/create-cookie-destination.md)
   ...
   + Stratégies de fusion de profils {#profile-merge-rules}
      ...
      + [Prise en main des stratégies de fusion de profils](features/profile-merge-rules/merge-rules-start.md)
      + [Tableau de bord des stratégies de fusion de profils](features/profile-merge-rules/merge-rules-dashboard.md)
      + [Définition des options des règles de fusion de profils](features/profile-merge-rules/merge-rule-definitions.md)
      ...
      + [Cas d’utilisation graphiques des appareils externes](features/profile-merge-rules/external-graph-use-cases.md)
      + [Mesures des rapports pour les stratégies de fusion de profils](features/profile-merge-rules/profile-link-metrics.md)
   ...
   + Segments {#segments}
      ...
      + [Mode Liste des segments](features/segments/segments-dashboard.md)
      + [Vue récapitulative du segment](features/segments/segment-summary-view.md)
   ...
   + Caractéristiques {#traits}
      ...
      + [Geotargeting avec clés au niveau de la plateforme](features/traits/trait-geotarget-keys.md)
...
+ Création de rapports {#reporting}
   ...
   + Rapports d’Audience Optimization {#audience-optimization-reports}
      + [Rapports sur les Audiences Optimization](reporting/audience-optimization-reports/audience-optimization-reports.md)
      + Audience Optimization pour les annonceurs {#audience-optimization-advertisers}
         + [Audience Optimization pour les annonceurs - Aperçu](reporting/audience-optimization-reports/aor-advertisers/aor-advertisers.md)
         ...
         + [Rapports d’analyse des tendances et des volumes](reporting/audience-optimization-reports/aor-advertisers/trend-analysis-volume-analysis.md)
      ...
      + Optimisation d’audience pour les éditeurs {#audience-optimization-publishers}
         + [Présentation de l’Audience Optimization pour les éditeurs](reporting/audience-optimization-reports/aor-publishers/aor-publishers.md)
      ...
      + Fichiers de données et de métadonnées pour les rapports Audience Optimization et les fichiers journaux pratiques {#data-and-metadata-files}
         ...
         + [Fichiers de données pour les rapports d’Audience Optimization et les fichiers journaux pratiques](reporting/audience-optimization-reports/metadata-files-intro/datafiles-intro.md)
   ...
   + Rapports interactifs et de chevauchement {#interactive-and-overlap-reports}
      ...
      + [Rapports de chevauchement : mise à jour de la planification et de la taille minimale du segment](reporting/dynamic-reports/overlap-minimum-segment-size.md)
   ...
   + [Rapport d’état d’intégration](reporting/onboarding-status-report.md)
...
+ Code de l’API et du SDK {#api-and-sdk-code}
   ...
   + Méthodes et code de l’API du serveur de collecte de données (DCS) {#dcs}
      ...
      + API DCS {#dcs-apis}
         ...
         + [Obtention des identifiants de région et d’utilisateur via le service Adobe Experience Platform Identity](api/dcs-intro/dcs-s2s/dcs-mcid-ids.md)
      ...
      + Référence d’API DCS {#dcs-api-reference}
         ...
         + [Codes, messages et exemples d’erreur DCS](api/dcs-intro/dcs-api-reference/dcs-error-codes.md)
   ...
   + API REST {#rest-apis}
      ...
      + Méthodes d’API de destination {#destination-api-methods}
         ...
         + [Renvoi d’une destination par un ID de destination](api/rest-api-main/aam-api-destinations/aam-api-retrieve-destinations.md)
...
+ API Data Integration Library (DIL) {#dil-api}
   + [Présentation du Data Integration Library (DIL)](dil/dil-overview.md)
   + Méthodes DIL au niveau de la classe {#class-level-dil-methods}
      + [Prise en main des API de DIL au niveau de la classe](dil/dil-class-overview/dil-start.md)
   ...
   + [Méthodes de DIL au niveau de l’instance](dil/dil-instance-methods.md)
   + [Modules DIL](dil/dil-modules.md)
   + [Outils de DIL](dil/dil-tools.md)
   + [Cas d’utilisation des DIL et exemples de code](dil/dil-use-cases.md)
...
+ Guides d’implémentation et d’intégration {#implementation-integration-guides}
   ...
   + Intégration de Google Ad Manager à l’aide des balises de l’éditeur Google (GPT){#integrate-dfp-using-gpt}
      ...
      + [Code d’Audience Manager pour les balises de l’éditeur Google](integration/gpt-aam-destination/gpt-aam-aamgpt-code.md)
   ...
   + [Implémentation de l’Audience Manager](integration/implement-audience-manager.md)
   + Intégration de données multimédias {#media-data-integration}
      ...
      + [Capture des données de clic de campagne via des appels de pixel](integration/media-data-integration/click-data-pixels.md)
   + Réception des données d’audience {#receiving-audience-data}
      ...
      + [Synchronisation des identifiants pour les transferts de données sortantes](integration/receiving-audience-data/id-sync-outbound.md)
...
+ Référence {#reference}
   ...
   + [Index des identifiants en Audience Manager](reference/ids-in-aam.md)
   ...
   + [Obsolescence du protocole TLS 1.0 et 1.1](reference/tls-support.md)
   + [Signification des appels vers le domaine Demdex](reference/demdex-calls.md)
   + [États d’authentification du visiteur en Audience Manager](reference/visitor-authentication-states.md)
+ Questions fréquentes {#faqs}
   + [FAQ sur l’Audience Manager](faq/faq-overview.md)
...
+ Principaux problèmes du service clientèle {#top-support-issues}
   ...
   + [Devrais-je voir mes segments mappés d’Audience Manager Audience Lab sur la page de détails des destinations ?](/help/using/support-issues/should-i-see-audience-lab-mapped-segments-on-the-destination-page.md)
