...
Le tableau suivant répertorie et décrit les conventions de dénomination des fichiers et les extensions de fichier utilisées dans un fichier .csv avec chevauchement. Dans les exemples, le texte en *italique* indique un espace réservé de variable.

<table id="table_C99FCABA365B4AB99620F27D4414E623"> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry"> Élément de métadonnées </th> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Les fichiers de rapport de chevauchement sont compressés au format GZIP et possèdent une extension de fichier <code> .gz</code>. Vous devez ajouter l’extension <code> .csv</code> au fichier après la décompression. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Syntaxe du nom de fichier : </p> <p> 
     <ul id="ul_D69D320A1AE94361B75D2AB47F90C4D1"> 
      <li id="li_FFB104975D104050AB67FEEC903C6E2E">Fichiers segment à segment : <code>S2S_overlap_<i>partner ID</i>_<i>yyyy-mm-dd</i>_<i>date range</i></code> </li> 
      <li id="li_7DEC51D693FB4377840D652AF40386EF">Fichiers segment à caractéristique : <code>S2T_overlap_<i>partner ID</i>_<i>yyyy-mm-dd</i>_<i>date range</i></code> </li> 
      <li id="li_CCB35A2BCB714E518AB279D453740623">Fichiers de caractéristique à caractéristique : <code>T2T_overlap_<i>partner ID</i>_<i>yyyy-mm-dd</i>_<i>date range</i></code> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>La période d’un rapport est un identifiant à 5 chiffres qui comprend : </p> <p> 
     <ul id="ul_7B334CDFD7DA42AC8F383BE0F8F77FB9"> 
      <li id="li_0045DED532E747C08824DCC98A9174B3"> <code> 70000</code> pour un rapport sur 7 jours. </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Nous incrémentons le dernier chiffre du nom de fichier si un rapport contient plusieurs fichiers. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Exemples </p> </td> 
   <td colname="col2"> <p>Exemples de noms de fichiers pour un seul rapport : </p> <p> 
     ...
     </ul> </p> <p>Exemples de noms de fichiers pour un rapport comportant plusieurs fichiers : </p> <p> 
...
Dans le fichier , les données de chaîne sont placées entre guillemets doubles. Voir les données simulées ci-dessous. Elle a été tronquée par souci de concision et pour s’adapter à l’écran.
...
## Enregistrements de rapport segment à segment {#segment-segment-records}

Un fichier de données pour votre [rapport de chevauchement de segments à segments](segment-segment-overlap-report.md) contient les enregistrements suivants.
...
<table id="table_1BDC7019DF2543069D7AE229C5E2454E"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Identifiant du segment que vous comparez au segment de base. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Identifiant de votre segment de base. Le segment de ligne de base est le segment que vous souhaitez comparer à d’autres segments. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Vous pouvez obtenir des rapports pour des intervalles de recherche en amont de 7 et 30 jours. La <code> rangeid</code> correspond aux intervalles de temps présentés ci-dessous. </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Nombre d’utilisateurs et d’utilisatrices uniques dans le segment que vous comparez au segment de base. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> segment_uniques2</code> </p> </td> 
   <td colname="col2"> <p>Nombre d’utilisateurs et d’utilisatrices uniques dans le segment de base. </p> </td> 
  </tr> 
  <tr> 
...
Un fichier de données pour votre [rapport de chevauchement de segments en caractéristiques](segment-trait-overlap-report.md) contient les enregistrements suivants.
...
<table id="table_45270B5D01014AD99921B320D3A32DB6"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Identifiant de la caractéristique. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Identifiant du fournisseur de données. Les identifiants incluent : </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Nombre d’utilisateurs et d’utilisatrices uniques dans le segment sélectionné. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> trait_uniques</code> </p> </td> 
   <td colname="col2"> <p>Nombre d’utilisateurs uniques dans une caractéristique. Dans le rapport de l’interface utilisateur, ce nombre s’affiche dans la fenêtre pop-up lorsque vous passez la souris sur une caractéristique dans les résultats de la carte thermique. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> overlap_uniques</code> </p> </td> 
   <td colname="col2"> <p>Nombre d’utilisateurs uniques partagés entre les segments et les caractéristiques sélectionnés. Dans le rapport de l’interface utilisateur, ce nombre s’affiche dans la fenêtre pop-up lorsque vous passez la souris sur une caractéristique dans les résultats de la carte thermique. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> trait_uniques_overlap_perc</code> </p> </td> 
   <td colname="col2"> <p>% d’utilisateurs uniques qui se chevauchent entre la caractéristique et le segment. Dans le rapport de l’interface utilisateur, ce nombre s’affiche dans la fenêtre pop-up lorsque vous passez la souris sur une caractéristique dans les résultats de la carte thermique. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> segment_uniques_overlap_perc</code> </p> </td> 
   <td colname="col2"> <p>% d’utilisateurs uniques qui se chevauchent entre le segment et la caractéristique. Dans le rapport de l’interface utilisateur, ce nombre s’affiche dans la fenêtre pop-up lorsque vous passez la souris sur une caractéristique dans les résultats de la carte thermique. </p> </td> 
  </tr> 
 </tbody> 
</table>

## Enregistrements de rapport de caractéristique à caractéristique {#trait-trait-records}

Un fichier de données pour votre [rapport de chevauchement de caractéristique à caractéristique](trait-trait-overlap-report.md) contient les enregistrements suivants.
...
<table id="table_603216E6AFE4439A87C91DDFF2989F53"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Identifiant de la caractéristique que vous comparez à la caractéristique de base. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Identifiant de votre caractéristique de base. La caractéristique de base est la caractéristique que vous souhaitez comparer à d’autres caractéristiques. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Nombre d’utilisateurs uniques partagés entre les caractéristiques sélectionnées. Dans le rapport de l’interface utilisateur, ce nombre s’affiche dans la fenêtre pop-up lorsque vous passez la souris sur une caractéristique dans les résultats de la carte thermique. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> base_trait_uniques</code> </p> </td> 
   <td colname="col2"> <p>Nombre d’utilisateurs uniques dans une caractéristique de base. Dans le rapport de l’interface utilisateur, ce nombre s’affiche dans la fenêtre pop-up lorsque vous passez la souris sur une caractéristique dans les résultats de la carte thermique. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> overlap_uniques</code> </p> </td> 
   <td colname="col2"> <p>Nombre d’utilisateurs uniques partagés entre les caractéristiques sélectionnées. Dans le rapport de l’interface utilisateur, ce nombre s’affiche dans la fenêtre pop-up lorsque vous passez la souris sur une caractéristique dans les résultats de la carte thermique. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>% d’utilisateurs uniques qui se chevauchent entre les caractéristiques sélectionnées. Dans le rapport de l’interface utilisateur, ce nombre s’affiche dans la fenêtre pop-up lorsque vous passez la souris sur une caractéristique dans les résultats de la carte thermique. </p> </td> 
  </tr> 
  <tr> 
