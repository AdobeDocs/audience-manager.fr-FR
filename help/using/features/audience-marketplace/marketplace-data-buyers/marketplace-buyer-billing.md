...
1. Cliquez sur **[!UICONTROL download the current usage]** pour vérifier que vous utilisez un fichier CSV valide.
...
1. [!DNL Audience Manager] valide le fichier dès que vous le téléchargez et vous invite à le vérifier s’il détecte des erreurs dans le fichier.
...
| ------------- | -------------| -----|
| Entrée non valide | [!DNL Audience Manager] a détecté une modification dans le schéma de  [!DNL CSV] fichier, telle que des colonnes manquantes ou des modifications dans le titre des colonnes. | Évitez de modifier la structure du tableau. |
...
| Valeurs non prises en charge | [!DNL Audience Manager] valeurs non numériques détectées dans la  [!DNL Audience Manager] colonne. | Consultez le rapport et veillez à n’entrer que des valeurs numériques dans la colonne [!DNL Audience Manager]. |
...
## [!DNL CPM] Bonnes pratiques en matière de reporting
