...
>[!NOTE]
>
>Pour le cas d’utilisation de la modélisation, vous ne devez signaler l’utilisation du CPM que sur activation. Si vous exécutez uniquement un modèle, mais ne l’activez pas, aucun rapports d’utilisation n’est requis.
