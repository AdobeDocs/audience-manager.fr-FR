...
Cliquez sur le nom d’un flux de données privé pour [!UICONTROL My Shared Data] accéder à une page qui contient plusieurs onglets. Cliquez sur un onglet pour gérer vos requêtes de flux de données privées.
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Liste les nouvelles demandes d’abonnement pour un flux de données privé. Cliquez sur cet onglet pour examiner, approuver ou rejeter les demandes d'acheteur. </p>
    <ul id="ul_BE0A835A90B14C05B3F63226B79D052D"> 
     <li id="li_2C5686CEB6F4430BA18AED5AD75C330A">Les acheteurs approuvés déménagent vers les abonnés <b><span class="uicontrol"></span></b>potentiels. </li>
     <li id="li_929591FCF81E43A3881813BDBD3AC278">Les acheteurs Refusés passent à Accès <b><span class="uicontrol"></span></b>refusé. </li>
    </ul> </td>
  </tr>
  <tr> 
   <td colname="col1"> <p> <b><span class="uicontrol"> Demandes de détails</span></b> </p> </td>
   <td colname="col2"> <p>Les Listes ont approuvé les acheteurs qui ne se sont pas encore abonnés à un flux de données et ont demandé plus d’informations sur vos flux. </p> <p>Une approbation permet aux acheteurs de vue d’un flux de données comme s’il était public. Cela leur permet de consulter et d’évaluer vos flux avant de s’abonner. Vous pouvez également offre des remises sur les flux de données aux acheteurs qui demandent l’accès. La réponse à une demande de détails supprime le profil acheteur de cet onglet. S'ils ne se sont pas abonnés, le profil acheteur est toujours dans les abonnés <b><span class="uicontrol"></span></b>potentiels. </p> </td>
  </tr>
  <tr> 
   <td colname="col1"> <p> <b><span class="uicontrol"> Accès refusé</span></b> </p> </td> 
   <td colname="col2"> <p>Les Listes ont rejeté les demandes d’abonnement pour un flux de données privé. </p> <p>Pour réapprouver les acheteurs refusés, modifiez le statut <span class="wintitle"></span> de rejet en <b><span class="uicontrol"> Autoriser</span></b>. L'acheteur est ainsi dirigé vers les abonnés <b><span class="uicontrol"></span></b>potentiels. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
En tant qu’acheteur, les flux de données privés s’affichent sur le [Marketplace](../../features/audience-marketplace/marketplace-data-buyers/marketplace-data-buyers.md#about-marketplace) comme toute autre offre. Cependant, dans ce cas, la liste de flux n’affiche pas d’informations récapitulatives sur les caractéristiques, les utilisateurs uniques et les chevauchements d’utilisateurs. En outre, le vendeur de données peut afficher ou masquer son nom dans la [!UICONTROL Provider] colonne de la [!UICONTROL Marketplace] liste. Une fois que le vendeur a approuvé votre demande d’abonnement, toutes les données d’un flux privé sont mises à votre disposition (il fonctionne comme un flux public). L’ [!UICONTROL Marketplace] exemple ci-dessous liste les trois différents types de flux disponibles en tant qu’acheteur.
...
La première étape du processus nécessite l’intervention du service de conseil ou du service à la clientèle d’Adobe. Le fournisseur de données et l’acheteur de données doivent contacter Adobe Consulting ou le service à la clientèle pour demander l’activation.
...
* **ID** d&#39;Audience Manager en tant que clé entrante ;
* L&#39;option **Partager activé** est cochée.

![](assets/create-datasource.png)

Une fois que vous avez cliqué sur **Enregistrer**, un nouveau sous-dossier est automatiquement créé dans Enregistrement **Caractéristiques > Données** tierces.
...
Ensuite, créez un flux de données pour partager vos caractéristiques avec l’acheteur de données. Reportez-vous à [Création d’un flux](/help/using/features/audience-marketplace/marketplace-data-providers/marketplace-create-manage-feeds.md) de données public ou privé pour obtenir des instructions sur la création d’un flux de données.
...
Accédez à **Audience Marketplace > Marketplace**. Recherchez le flux de données créé par le fournisseur de données à l’étape précédente. Cliquez sur **Demander l’accès**. Le contact désigné du fournisseur de données recevra désormais une notification par courrier électronique. Voir aussi [S’abonner à un flux](/help/using/features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md#subscript-private-data-feed)de données privé.

### Étape 6 - Fournisseur de données - Octroi d&#39;un accès

Accédez à **Audience Marketplace > Mes données** partagées et recherchez le flux que vous avez créé à l’étape 4. Cliquez sur dans la nouvelle demande d’accès et cliquez sur **Autoriser l’accès** pour approuver la demande. Voir également [Révision, Approbation ou rejet de demandes](/help/using/features/audience-marketplace/marketplace-data-providers/marketplace-create-manage-feeds.md#manage-private-requests)de flux privés.

### Étape 7 - Acheteur de données - Activer l&#39;Abonnement

Une fois que le fournisseur de données a accordé l’accès au flux de données, vous pouvez afficher le flux dans votre compte dans **Audience Marketplace > Marketplace**. Vérifiez les détails, activez le bouton Abonnement, puis cliquez sur **Révision et abonnement**. Voir [Enregistrement pour les flux](/help/using/features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md#find-subscribed-data-fee) de données abonnés pour en savoir plus sur l’emplacement des caractéristiques tierces.
