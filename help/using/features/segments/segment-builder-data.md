...
[!UICONTROL Segment Builder] vous montre [!UICONTROL Total Trait Population] pour le dernier jour où vous ajoutez un [!UICONTROL trait] à un segment. Ces données apparaissent dans le champ bleu autour du [!UICONTROL trait] sélectionné dans la section [!UICONTROL Basic View].
...
<table id="table_B24503F372E34B6BBDF5204181701A59"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Nombre estimé de visiteurs uniques affichés en temps réel pendant la période spécifiée et qui étaient qualifiés pour le segment au moment où ils ont été vus par l’Audience Manager. </p> <p>Dans le <span class="wintitle"> créateur de segments </span>, les 30 derniers jours de populations pour les caractéristiques (<span class="wintitle"> Population totale de caractéristiques</span>) peuvent être différents pour les caractéristiques et les segments évalués en temps réel. </p> <p>
     ...
     </ul> </p> <p> <p>Remarque : La mesure <span class="wintitle"> Population estimée en temps réel </span> n’inclut pas les appareils qualifiés pour un segment en fonction des connexions fournies par une <span class="wintitle"> stratégie de fusion de profils </span> qui utilise une <a href="../../features/profile-merge-rules/merge-rule-definitions.md#device-options"> option de représentation graphique des appareils </a>. </p> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Nombre estimé de visiteurs uniques pouvant se trouver dans votre segment nouveau ou modifié. Comme pour la plupart des estimations, les performances antérieures ne garantissent pas les résultats futurs, mais vous pouvez utiliser le total estimé pour : </p> <p> 
     ...
     </ul> </p> <p> <p>Remarque : La mesure <span class="wintitle"> Population totale estimée</span> n’inclut pas les appareils qualifiés pour un segment en fonction des connexions fournies par une <span class="wintitle"> stratégie de fusion de profils</span> qui utilise une <a href="../../features/profile-merge-rules/merge-rule-definitions.md#device-options"> option de représentation graphique des appareils</a>. </p> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
[!UICONTROL Profile Merge Rules] affecte les nombres réels en temps réel et total de la population. Ces totaux varient selon que le [!UICONTROL Profile Merge Rule] auquel un segment appartient utilise ou non une représentation graphique des appareils. Voir aussi [Options de stratégie de fusion de profils définies](../../features/profile-merge-rules/merge-rule-definitions.md).

### Données de population de segment pour [!UICONTROL Merge Rules] sans [!UICONTROL Device Graph Option]

Le tableau suivant définit les mesures de population totales et en temps réel lorsque vos segments sont utilisés par une option [!UICONTROL Profile Merge Rule] créée sans [!UICONTROL device graph]. Il s’agit des paramètres des options de l’appareil **[!UICONTROL No Device Options]** et **[!UICONTROL Current Device Proflie]**.
...
<table id="table_A18C973855DB46A0B39B81F32E0E7540"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Nombre réel de visiteurs uniques affichés en temps réel pendant la période spécifiée et qui étaient qualifiés pour le segment au moment où ils ont été vus par l’Audience Manager. </p> <p>Dans le <span class="wintitle"> créateur de segments </span>, les 30 derniers jours de populations pour les caractéristiques (<span class="wintitle"> Population totale de caractéristiques</span>) peuvent être différents pour les caractéristiques et les segments évalués en temps réel. </p> <p> 
...
Le tableau suivant définit les mesures de population totales et en temps réel lorsque vos segments sont utilisés par une option [!UICONTROL Profile Merge Rule] créée avec une option [!DNL device graph]. Il s’agit des paramètres d’options de l’appareil pour [!UICONTROL Profile Link Device Graph], [!DNL Adobe] [!DNL device graph] et d’autres options tierces [!DNL device graph] disponibles pour vous.
...
### Limites dues à [!UICONTROL Merge Rules] lors de l’estimation de la population de segments
