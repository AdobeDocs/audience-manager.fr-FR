...
Code requis par [!DNL DART Enterprise] (et d’autres types de destination) pour capturer la valeur d’identifiant utilisateur unique d’Audience Manager ([!DNL UUID]).
