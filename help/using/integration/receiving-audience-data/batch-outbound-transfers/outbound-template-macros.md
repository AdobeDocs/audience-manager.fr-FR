---
description: Répertorie les macros que vous pouvez utiliser pour créer des modèles sortants. Il s’agit notamment des macros de nom de fichier, d’en-tête et de contenu.
...
<table id="table_C353AF028E0A4944A8727FD01C94FDB6"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Alias pour un identifiant de commande/destination. </p> <p>L’alias est défini dans l’interface utilisateur d’administration. </p> </td> 
  </tr>
  <tr> 
...
<p>Les trois derniers chiffres (001 002 003) des exemples ci-dessus sont les identifiants SPLITNUM.</p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Horodatage Unix, UTC, à 10 chiffres. </p> <p>Il peut également être formaté comme <code> &lt;TIMESTAMP; format="YYYYMMDDhhmmss"&gt; </code> règles de formatage de date/heure Java suivantes. </p> </td> 
  </tr>
...
<table id="table_5C6F9678CFF34C5EB67BA1DEA0479F1D"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Cette combinaison de macros crée une instruction conditionnelle qui répertorie les segments auxquels les utilisateurs appartiennent et dont ils ont été supprimés. Elle renvoie une chaîne vide si les deux conditions ne sont pas remplies ou s’il n’existe aucune donnée. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p> <code> ORDER_ID </code> </p> </td> 
   <td colname="col2"> <p>Identifiant de commande ou de destination. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Renvoie une liste de segments dans une liste. Accepte les arguments optionnels suivants : </p> 
    <ul id="ul_B111AA0D6C18445598A1444B8B7E9325"> 
     ...
     <li id="li_1EF40DDCA3C5447586904CF021D8F912"> <code> csegid </code> : identifiant de segment client. Obsolète. Utilisez <code> sid </code>. </li> 
     ...
     <li id="li_DD778AA2D1DB4D409CF5026B5D9DBD27"> <code> lastUpdateTime </code> : horodatage Unix indiquant l’heure de la dernière mise à jour du statut d’appartenance au segment. </li>
     <li id="li_DD778AA2D1DB4D409CF5026B5D9DBD28"> <code> lastRealizationTime </code> : horodatage Unix qui indique la dernière fois qu’un segment a été réalisé. </li>
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Renvoie une liste de caractéristiques. Accepte les arguments optionnels suivants : </p> 
    ...
    </ul> <p>Placez ces variables entre crochets après la macro. Par exemple, ce code sépare les résultats avec une barre verticale « | » : <code> &lt;TRAIT_LIST:{trait|&lt;trait.Id&gt;,&lt;trait.lastRealized&gt;};separator="," </code> </p> </td> 
  </tr> 
  <tr> 
