...
<table id="table_9017F44983CC49E888BE3470430D7ACB"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Nous avons mis à jour la documentation afin d’inclure les nouvelles fonctionnalités de recherche et de filtrage pour les groupes de test. Voir la section <a href="../features/audience-lab/audience-lab.md#search-and-filter"> Rechercher et filtrer des groupes de test</a> . </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../reference/system-components/components-data-action.md"> Optimisations IRIS</a> </p> </td> 
   <td colname="col2"> <p>Pour plus d’informations sur l’ensemble de règles appliquées par IRIS lors de l’envoi de segments vers des destinations, voir <b>Règles de mappage de segments</b> . </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../reporting/general-reports.md#general-reports-overview"> Améliorations apportées à la documentation générale sur les rapports</a> </p> </td> 
   <td colname="col2"> <p>Des définitions et des exemples ont été ajoutés pour toutes les mesures dans les rapports généraux. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_BAB960ED4DA1432087A162210681B225"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Pour les clients qui utilisent Audience Manager et Adobe Analytics : l’interface utilisateur de l’Audience Manager ne vous permet pas de supprimer des sources de données créées automatiquement de vos suites de rapports Analytics. Utilisez le <a href="https://experienceleague.adobe.com/en/docs/core-services/interface/services/customer-attributes/attributes" format="https" scope="external"> Core Service</a> pour démapper ces sources de données. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_01EF3D23C50F4635BFBD55F9D6CE1752"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>À partir de la version 8.0, le <span class="wintitle"> DIL</span> dépend fortement de <a href="https://experienceleague.adobe.com/docs/id-service/using/home.html" format="https" scope="external"><span class="keyword"> Adobe Experience Platform Identity Service</span></a>, version 3.3 ou supérieure. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../dil/dil-overview.md"> Comprendre le Data Integration Library (DIL)</a> </p> </td> 
   <td colname="col2"> <p>Modification de <a href="../dil/dil-overview.md"> Obtention et mise en oeuvre du code du DIL </a> afin de tenir compte du fait que <span class="keyword"> Adobe Experience Platform Launch</span> est l’outil de déploiement de code préféré dans l’ <span class="keyword"> Experience Cloud</span>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../features/audience-lab/audience-lab.md"> Audience Lab</a> </p> </td> 
   <td colname="col2"> <p>La page d’aperçu d’Audience Lab comprend désormais un champ de recherche, ce qui vous permet de trouver facilement n’importe lequel de vos groupes de test. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_728845C945394BCC8689ACF50EDDB577"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../reporting/audience-optimization-reports/aor-publishers/import-dfp.md"> Importation de fichiers de données DFP dans l’Audience Manager </a> </p> </td> 
...
<table id="table_2D7B56FFB0134D18894E0493043C32BD"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../reference/tls-support.md"> Obsolescence TLS 1.0</a> </p> </td> 
...
<table id="table_F2018CE3F64E4A1FAA9289EEA17D4E4D"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>À compter du 29 mars 2018, tous les clients d’Audience Manager qui sont sur <a href="https://www.ampproject.org/learn/overview/" format="https" scope="external"> Accelerated Mobile Pages</a> (AMP) devront tirer parti de l’intégration côté serveur lors de l’envoi d’audiences à Google DoubleClick for Publishers (DFP). </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../integration/receiving-audience-data/batch-outbound-transfers/authorize-s3-cross-bucket.md"> Utilisation des autorisations de compartiments inter-comptes Amazon S3 pour les fichiers de sortie </a> </p> </td> 
