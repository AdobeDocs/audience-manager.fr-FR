...
<table id="table_9017F44983CC49E888BE3470430D7ACB"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Nous avons mis à jour la documentation afin d’inclure les nouvelles fonctionnalités de recherche et de filtrage pour les groupes de tests. Voir la section <a href="../features/audience-lab/audience-lab.md#search-and-filter"> Recherche et filtrage des groupes de tests</a>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_BAB960ED4DA1432087A162210681B225"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Pour les clients qui utilisent l'Audience Manager et Adobe Analytics : L’interface utilisateur de l’Audience Manager ne vous permet pas de supprimer les sources de données créées automatiquement à partir de vos suites de rapports Analytics. Utilisez le service principal <a href="https://docs.adobe.com/content/help/en/core-services/interface/about-core-services/core-services-landing.html" format="https" scope="external"></a> pour annuler le mappage de ces sources de données. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_01EF3D23C50F4635BFBD55F9D6CE1752"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>À partir de la version 8.0, <span class="wintitle"> DIL</span> a une forte dépendance sur <a href="https://docs.adobe.com/content/help/fr-FR/id-service/using/home.html" format="https" scope="external"><span class="keyword"> Service d'identité Adobe Experience Platform</span></a>, version 3.3 ou supérieure. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../dil/dil-overview.md"> Présentation de Data Integration Library (DIL)</a> </p> </td> 
   <td colname="col2"> <p>Modification de <a href="../dil/dil-overview.md"> Obtention et implémentation du code du DIL</a> pour tenir compte du fait que <span class="keyword"> Adobe Experience Platform Launch</span> est l'outil de déploiement du code préféré dans l'Experience Cloud <span class="keyword"> </span>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_2D7B56FFB0134D18894E0493043C32BD"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Les demandes de GET ont une longueur de contenu maximale de 8 Ko. Vous pouvez en savoir plus sur les méthodes d'API GET et POST en visitant cette page. </p> </td> 
  </tr> 
  <tr> 
