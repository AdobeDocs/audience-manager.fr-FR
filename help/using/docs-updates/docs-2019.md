...
| Rubrique | Description |
|--- |----|
| [API Audience Manager](/help/using/api/rest-api-main/rest-api-main.md) | Nous sommes en train de [migrer toutes nos API](/help/using/api/api-swagger-migration.md) de la documentation du produit vers l’API Swagger. Les deux dernières API que nous avons migrées sont les suivantes : <ul><li>[Algorithmic Models API](https://bank.demdex.com/portal/swagger/index.html#/Algorithmic_Models_API)</li><li>[API Signaux dérivés](https://bank.demdex.com/portal/swagger/index.html#/Derived_Signals_API)</li></ul> |
