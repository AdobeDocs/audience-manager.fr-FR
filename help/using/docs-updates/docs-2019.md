...
| [Recency and Frequency](/help/using/features/segments/recency-and-frequency.md) | Nous avons mis à jour les exemples de plafonnement des fréquences dans l’article et ajouté des exemples de fonctionnement de la récence. |
...
| Rubrique | Description |
|--- |----|
| [Page d'accueil Destinations](/help/using/features/destinations/destinations-home.md) | La page d’entrée [Destinations](https://bank.demdex.com/portal/destinations/all) a une nouvelle apparence. Read this page for information about the new layout. |
...
| [Flux de données privés](/help/using/features/audience-marketplace/marketplace-private-feeds.md#set-up-sharing-relationship) | Nous avons amélioré la documentation relative au partage de données propriétaires à l’aide de flux de données privés. See the new section, How to set up the Sharing Relationship between Data Provider and Data Buyer. |
...
| [Usage Limits](/help/using/features/administration/usage-limits.md) | Nous avons mis à jour la façon dont Audience Manager traite la limite des modèles algorithmiques. Audience Manager compte désormais uniquement les modèles algorithmiques *actifs* par rapport à la limite. |
