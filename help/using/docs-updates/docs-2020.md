...
source-git-commit: efe29244062e57ec89cc125c6ce94760e04844db
workflow-type: tm+mt
...
|----|----|
| [Audiences prédictives](/help/using/features/algorithmic-models/predictive-audiences.md) | <ul><li>**Clonage** de modèle des Audiences prédictives : Vous pouvez désormais cloner des modèles existants et modifier leur configuration en fonction de vos besoins. Pour plus d&#39;informations, consultez [Clonage et modification des modèles d&#39;Audience prédictive](/help/using/features/algorithmic-models/predictive-audiences.md#clone-predictive-audiences).</li><li>**Classification** par lots des Audiences prédictives : Outre la classification des visiteurs selon des personnalités distinctes en temps réel, les Audiences prédictives prennent désormais en charge la classification par lot, ce qui vous permet de classer les utilisateurs intégrés et de les activer dans les destinations par lot.</li></ul> |
| [Rapports de chevauchement](/help/using/reporting/dynamic-reports/dynamic-reports.md) | Nous avons mis à jour la méthodologie que nous utilisons pour calculer les rapports de chevauchement ([Caractéristique à caractéristique](/help/using/reporting/dynamic-reports/trait-trait-overlap-report.md), [Segment à caractéristique](/help/using/reporting/dynamic-reports/segment-trait-overlap-report.md), [Segment à segment](/help/using/reporting/dynamic-reports/segment-segment-overlap-report.md)). Le calcul des rapports de chevauchement est désormais basé sur les signatures de rapports et de hachage minimum (plutôt que sur [l’échantillonnage de données 1/54](/help/using/reporting/report-sampling.md#data-sampling-ratio)). |
...
| Rubrique | Description |
|---- |----|
| [Accessibilité dans l&#39;Audience Manager](/help/using/overview/accessibility-in-aam.md) | L&#39;accessibilité se rapporte à une série de fonctions qui rendent un produit logiciel utilisable, avec le moins d&#39;effort possible de la part d&#39;utilisateurs ayant divers handicaps, tels que visuels, auditifs, cognitifs, moteurs ou autres. Pour faciliter l&#39;utilisation de l&#39;Audience Manager pour tous, nous avons développé la prise en charge de plusieurs fonctions d&#39;accessibilité, détaillées dans cet article. |
| [Nom ](/help/using/integration/sending-audience-data/batch-data-transfer-explained/inbound-s3-filenames.md) de fichier S3 entrant et nom de fichier FTP  [entrant](/help/using/integration/sending-audience-data/batch-data-transfer-explained/inbound-ftp-filenames.md) | Nous avons mis à jour les définitions et fourni des exemples pour les champs `DPID` et `DPID_TARGET_DATA_OWNER` dans la syntaxe du nom de fichier. |

## Août 2020 {#aam-august-updates}

| Rubrique | Description |
|---- |----|
| [Correspondance client Google pour les destinations basées sur les personnes](../features/destinations/people-based-destinations-prerequisites.md#gcm) | Vous pouvez désormais utiliser [!UICONTROL People-Based Destinations] pour cible des utilisateurs via [!DNL Google Customer Match]. Avant de pouvoir utiliser [!UICONTROL People-Based Destinations] pour envoyer vos segments d&#39;audience propriétaire vers une destination [!DNL Google Customer Match], il est obligatoire que [!DNL Google] vous ajoute à leur liste autorisée. Pour plus d’informations, consultez la documentation [Destinations basées sur les personnes](../features/destinations/people-based-destinations-prerequisites.md#gcm). |
...
| [Prise en main des API REST d’Audience Manager](/help/using/api/rest-api-main/aam-api-getting-started.md#jwt) | Nous avons ajouté une nouvelle section, **Authentification JWT (Service Account) à l&#39;aide de[!DNL Adobe I/O]**. Reportez-vous à cette section pour vous authentifier auprès des API d&#39;Audience Manager à l&#39;aide de [!DNL Adobe I/O]. |

## Juin 2020 {#aam-june-updates}

| Rubrique | Description |
|---- |----|
| [Prise en charge du contrôle des exportations de données d&#39;Audience Manager dans Adobe Experience Platform](/help/using/integration/integration-aep/aam-aep-audience-sharing.md#aam-data-export-control-in-aep) | La nouvelle section de l’article Partage des Audiences entre l’Audience Manager et Adobe Experience Platform comprend un mappage entre les contrôles d’exportation des données d’Audience Manager et les étiquettes d’utilisation des données Experience Platform. |
