...
| [Nouveaux serveurs SFTP](../faq/faq-data-collection.md) | Vous pouvez désormais utiliser les nouveaux [!DNL SFTP] serveurs (`ftp-in-gtw` et `ftp-out-gtw`) qui utilisent [!DNL AWS SFTP Gateway] sur [!DNL S3]. |
