...
|---- |----|
| [Module externe Audience Manager pour IAB TCF ](../overview/data-security-and-privacy/aam-iab-plugin.md) | En continuant à mettre l’accent sur la protection des renseignements personnels par conception, Adobe met à niveau le module externe Audience Manager pour le TCF IAB vers la version 2.0 de l’IAB Transparency &amp; Consent Framework (TCF), à compter du 10 juin 2020. Les clients qui ont mis en oeuvre le module externe Audience Manager pour IAB TCF doivent effectuer la mise à niveau vers la version 2.0 d’ici le 15 août 2020, afin de continuer à utiliser cette fonctionnalité. Après le 15 août 2020, la version 1.1 sera abandonnée et ne sera plus prise en charge. |
...
| [Transfert de données d’Adobe Analytics vers Audience Manager](../integration/integration-other-solutions/audience-management-module.md) | Nous avons mis à jour cette page pour mettre en évidence le lancement de la plateforme d’expérience Adobe comme moyen privilégié de transférer des données d’Adobe Analytics vers Audience Manager. |
