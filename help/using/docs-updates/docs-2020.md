...
|----|----|
| [Audiences prédictives](/help/using/features/algorithmic-models/predictive-audiences.md) | <ul><li>**Clonage des modèles de Predictive Audiences**: Vous pouvez désormais cloner des modèles existants et modifier leur configuration en fonction de vos besoins. Lecture [Clonage et modification des modèles d’audience prédictive](/help/using/features/algorithmic-models/predictive-audiences.md#clone-predictive-audiences) pour plus d’informations.</li><li>**Classification par lot des audiences prédictives**: Outre la classification des visiteurs selon des personnalités distinctes en temps réel, Predictive Audiences prend désormais en charge la classification par lots, ce qui vous permet de classer les utilisateurs intégrés et de les activer dans des destinations par lot.</li></ul> |
...
| [Noms de fichiers S3 entrants](/help/using/integration/sending-audience-data/batch-data-transfer-explained/inbound-s3-filenames.md) et [noms de fichiers FTP entrants](/help/using/integration/sending-audience-data/batch-data-transfer-explained/inbound-ftp-filenames.md) | Nous avons mis à jour les définitions et fourni des exemples pour le `DPID` et `DPID_TARGET_DATA_OWNER` dans la syntaxe du nom de fichier. |

## Août 2020 {#aam-august-updates}

| Rubrique | Description |
|---- |----|
| [Correspondance client Google pour les destinations basées sur les personnes](../features/destinations/people-based-destinations-prerequisites.md#gcm) | Vous pouvez désormais utiliser [!UICONTROL People-Based Destinations] pour cibler les utilisateurs via [!DNL Google Customer Match]. Avant d’utiliser [!UICONTROL People-Based Destinations] pour envoyer vos segments d’audience propriétaires à un [!DNL Google Customer Match] destination, il est obligatoire que [!DNL Google] vous ajoute à leur liste autorisée. Vérifiez les [Destinations basées sur les personnes](../features/destinations/people-based-destinations-prerequisites.md#gcm) pour plus d’informations. |
| [Nouveaux serveurs SFTP](../faq/faq-data-collection.md) | Vous pouvez désormais utiliser la nouvelle [!DNL SFTP] Serveurs ([!DNL ftp-in-gtw] et [!DNL ftp-out-gtw]) qui utilisent [!DNL AWS SFTP Gateway] over [!DNL S3]. |
...
| Rubrique | Description |
|---- |----|
| [Partage d’audiences entre Audience Manager et Adobe Experience Platform](/help/using/integration/integration-aep/aam-aep-audience-sharing.md#aep-aam-segment-population-differences) | la nouvelle section, **Comprendre les différences de population de segment entre l’Audience Manager et l’Experience Platform**, décrit les raisons possibles pour lesquelles le nombre de populations peut varier entre Experience Platform et Audience Manager. |
