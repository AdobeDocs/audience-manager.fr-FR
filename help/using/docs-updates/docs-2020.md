...
| [Module d’Audience Manager pour le TCF de l’IAB](../overview/data-security-and-privacy/aam-iab-plugin.md) | Adobe Dans la continuité de notre travail sur la protection des données dès la conception, nous mettons à niveau le module externe Audience Manager pour IAB TCF vers la version 2.0 du Transparency &amp; Consent Framework (TCF) de l’IAB, à compter du 10 juin 2020. Les clients qui ont mis en œuvre le module externe Audience Manager pour IAB TCF doivent effectuer la mise à niveau vers la version 2.0 d’ici le 15 août 2020 afin de continuer à utiliser la fonctionnalité. Après le 15 août 2020, la version 1.1 sera obsolète et ne sera plus prise en charge. |
