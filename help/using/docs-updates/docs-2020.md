...
feature_v2: id: a8b0238e-1d43-4679-a3b4-5ba1bad83baaid: a99472c1-6aae-4c7a-8aa0-f60636369620id: baaa0dd2-d27e-4921-aae3-7888623a5fa5id: c814092e-2730-45e8-a12d-e084529f52cbid: ce14ba14-a06d-4b2b-b7dd-04cb862494ec
subfeature_v2: id: a49258d4-867f-4130-b875-d72c001bdf6cid: c2c33729-f309-4bc2-92ba-87c475259df3id: d3dfac44-e20d-492d-a806-0f4a4a495901id: f341dd0b-34de-403e-a549-e0f581dcdda6id: fa77d762-7e75-47b2-9bb4-e3fcf50d251d
topic_v2: id: aa2f3246-cb95-4b30-8899-fdf7d73550ccid: b5ce8718-c3af-4fdb-a1a9-fca32f83a87cid: cc72dcf1-72e1-48cc-b434-e7c27d62d67cid: e1e0219c-f879-479f-8427-888ed2a6e9c2id: eb30f47f-d87a-400f-8f78-63ce7979ff56id: eddd9b14-83bd-4ff4-9072-54a4a484abb7id: f4e6943a-c91a-4134-a2c7-f4f20cfff2f0
...
| [Module d’Audience Manager pour le TCF de l’IAB](../overview/data-security-and-privacy/aam-iab-plugin.md) | Dans la continuité de notre travail sur la protection des données dès la conception, nous mettons à niveau le module externe Audience Manager pour IAB TCF vers la version 2.0 du Transparency &amp; Consent Framework (TCF) de l’IAB, à compter du 10 juin 2020. Les clients qui ont mis en œuvre le module externe Audience Manager pour IAB TCF doivent effectuer la mise à niveau vers la version 2.0 d’ici le 15 août 2020 afin de continuer à utiliser la fonctionnalité. Après le 15 août 2020, la version 1.1 sera obsolète et ne sera plus prise en charge. |
...
| Rubrique | Description |
|---- |----|
| [Audiences prédictives](../features/algorithmic-models/predictive-audiences.md) | [!UICONTROL Predictive Audiences] vous aider à classer une audience inconnue en personnages distincts, en temps réel, à l’aide de techniques avancées de science des données. <br><br> Dans un contexte marketing, une personne est un segment d’audience défini par des visiteurs, des utilisateurs ou des acheteurs potentiels qui partagent un ensemble spécifique de caractéristiques, telles que les données démographiques, les habitudes de navigation, l’historique des achats, etc.<br><br>[!UICONTROL Predictive Audiences] les modèles vont plus loin avec ce concept en vous permettant d’utiliser les fonctionnalités de machine learning d’Audience Manager pour classer des audiences inconnues en personnages distincts. <br><br>Pour ce faire, Audience Manager calcule la propension de votre audience propriétaire inconnue pour un ensemble d’audiences propriétaires connues. |
| Autres améliorations de [!UICONTROL Profile Merge Rules] | [!UICONTROL Profile Merge Rules] permet aux clients Audience Manager de définir, gérer et activer des segments d’audience en fonction de l’identité plutôt que des appareils. <br><br> À compter du 29 avril, les clients Audience Manager pourront mieux comprendre la répartition des populations d’identifiants d’appareils et inter-appareils pour les caractéristiques et les segments dans la segmentation individuelle et les rapports en bloc dans l’interface utilisateur d’Audience Manager. <br><br> Cela permettra de mieux comprendre l’identité dans Audience Manager, offrant ainsi aux clients une vue holistique de la population totale du segment par appareil, personne et foyer. Les exportations de caractéristiques en bloc des ID sur plusieurs appareils et appareils seront également mises à jour pour prendre en compte ces améliorations.<br><br>  Les mises à jour spécifiques incluent la possibilité de : <ul><li>de créer des rapports concernant les [identifiants multi-appareils](../reference/ids-in-aam.md) dans les rapports [généraux](../reporting/general-reports.md) et de [tendances](../reporting/trend-reports.md) ;</li><li>d’améliorer le [!UICONTROL Trait Selector] du [Créateur de segments](../features/segments/segment-builder.md) afin d’inclure les populations de caractéristiques en dehors des [identifiants CRM](../reference/ids-in-aam.md) ;</li><li>de créer des exportations de caractéristiques précises en dehors des [identifiants multi-appareils](../reference/ids-in-aam.md) ;</li><li>de créer des exportations de caractéristiques précises en dehors des [identifiants d’appareils](../reference/ids-in-aam.md) (les caractéristiques authentifiées devraient en être exclues) ;</li><li>de renvoyer les valeurs correctes des caractéristiques associées aux [identifiants CRM](../reference/ids-in-aam.md) lorsqu’elles font l’objet d’une requête à l’aide de l’outil [BAAAM](../reference/bulk-management-tools/bulk-management-intro.md).</li></ul> |
