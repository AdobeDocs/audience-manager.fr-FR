...
| [Noms de fichiers](/help/using/integration/sending-audience-data/batch-data-transfer-explained/inbound-s3-filenames.md) S3 entrants et noms de fichiers FTP [entrants](/help/using/integration/sending-audience-data/batch-data-transfer-explained/inbound-ftp-filenames.md) | Nous avons mis à jour les définitions et fourni des exemples pour les champs `DPID` et `DPID_TARGET_DATA_OWNER` dans la syntaxe des noms de fichier. |

## August, 2020 {#aam-august-updates}

| Rubrique | Description |
|---- |----|
| [Correspondance client Google pour les destinations basées sur les personnes](../features/destinations/people-based-destinations-prerequisites.md#gcm) | Vous pouvez désormais utiliser [!UICONTROL People-Based Destinations] pour cible les utilisateurs via [!DNL Google Customer Match]. Avant de pouvoir utiliser [!UICONTROL People-Based Destinations] l’envoi de segments d’audience propriétaires vers une [!DNL Google Customer Match] destination, il est obligatoire de [!DNL Google] vous ajouter à leur liste autorisée. Pour plus d’informations, consultez la documentation sur les destinations [](../features/destinations/people-based-destinations-prerequisites.md#gcm) basées sur les personnes. |
