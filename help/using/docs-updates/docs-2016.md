...
<table id="table_D16570793032445FBC18F662BF9DDA7A"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Après une mise à jour de Google en mai 2016, vous pouvez charger le code de DIL dans la section de HTML personnalisée d’une balise. Vous n’avez plus besoin d’héberger le code à distance. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../faq/faq-data-collection.md"> FAQ sur la collecte de données et l’intégration de produit </a> </p> </td> 
   <td colname="col2"> <p>Inclut une nouvelle entrée sur la liste blanche <span class="keyword"> Audience Manager</span> Adresses IP et FTP. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Documentation qui décrit une nouvelle méthode de DIL qui vous permet d’envoyer des données à <span class="keyword"> Audience Manager</span> de Google Universal Analytics. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_D83514BA7F5745DA80D6135804D5BD5F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <span class="keyword"> Audience Manager</span> gère les états d’authentification de l’identifiant visiteur. <code> UNKNOWN</code> et <code> LOGGED_OUT</code> de la même manière. Le document fournit des informations supplémentaires sur la façon dont nous gérons la <code> setCustomerID</code> appels d’événement. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Consultez ce document pour obtenir une liste complète des <span class="keyword"> Audience Manager</span> ID. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../faq/faq-audience-lab.md"> FAQ sur Audience Lab </a> </p> </td> 
   <td colname="col2"> <p>Questions fréquentes sur le <span class="wintitle"> Audience Lab</span> fonction . </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Nouveau contenu qui décrit les fonctionnalités de la <span class="wintitle"> Destinations</span> landing page. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_B19586DBA5D44F8E9D06610DB704EFB9"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2">Ajout de la capacité de sécuriser votre transfert de données sortantes en temps réel via le protocole OAuth 2.0. Contactez votre <span class="keyword"> Adobe Audience Manager</span> consultant pour commencer. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Révision de la remarque : <code> GA.init()</code> ne fonctionne pas avec la dernière version du code d’analyse de Google, <code> analytics.js</code>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <i>Cette fonction a été abandonnée.</i><p>Révision afin d’inclure plus d’informations sur la variable <span class="keyword"> Adobe Experience Cloud Device Co-op</span>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_9B18916DD43E4DB38C0C340DE4E3DF62"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <a href="https://experienceleague.adobe.com/docs/core-services/interface/ec-cookies/cookies-am.html" format="https" scope="external"> Cookies utilisés dans l’Experience Cloud</a> </td> 
   <td colname="col2"> Modification de la valeur TTL (time-to-live) du cookie demdex et du cookie partenaire à 180 jours pour se conformer aux réglementations CNIL françaises. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <a href="../dil/dil-overview.md"> Présentation de Data Integration Library (DIL) </a> </td> 
   <td colname="col2">Un aperçu général de la <span class="wintitle"> Bibliothèque d’informations sur les données</span> (DIL). </td> 
  </tr> 
  <tr> 
...
<table id="table_50CD90671E4B4C50A624AC0948FA8324"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Mise à jour du contenu expliquant pourquoi DIL utilise <code> GET</code> et <code> POST</code> méthodes pour envoyer des données dans un appel d’événement. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_183F245818BC4CF5AAB9B610C1BE4A9F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Mise à jour de la <span class="wintitle"> Audience Optimization</span>rapports avec conversion multicanaux, contrôle d’accès en fonction du rôle, groupes de conversion et caractéristiques de conversion rapportées. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Le <span class="wintitle"> Conversion cross-canal</span> dans le <span class="wintitle"> Audience Optimization</span> Les rapports vous permettent d’attribuer des conversions hors ligne à des impressions ou des clics en ligne diffusés. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_E71252DF328F42A3AB0BD2CA7DC5A549"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Supprimé de <span class="keyword"> Audience Manager</span> documentation de septembre 2017. Déplacé vers <span class="keyword"> Analytics</span> documentation. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_106BAD4680F1446B813A907F9E3ADCB8"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="https://experienceleague.adobe.com/docs/audience-manager/user-guide/implementation-integration-guides/integration-experience-platform/aam-aep-audience-sharing.html" format="https" scope="external"> Audience Manager de segments dans Analytics</a> </p> </td> 
...
<table id="table_BF1B40564C3C4B569A3B2504ACEEE0E4"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md">Que se passe-t-il une fois qu’un fournisseur désactive mon flux de données ?</a> </p> </td> 
   <td colname="col2"> <p>Décrit ce qu’un <span class="wintitle"> Audience Marketplace</span> l’acheteur de données peut s’attendre à ce qu’un fournisseur révoque l’accès à un flux de données. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../api/dcs-intro/dcs-api-reference/dcs-error-codes.md"> Codes, messages et exemples d’erreur des serveurs de collecte de données </a> </p> </td> 
...
<table id="table_AC8FF0DB45B546C69D89749FF0FA1CCD"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2" morerows="1"> <p>Révision du texte afin d’inclure le <code> d_mid</code> . </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Nouvelle documentation qui répertorie et définit les éléments d’une <span class="wintitle"> Audience Marketplace</span> rapport de facturation. </p> </td> 
  </tr> 
  <tr> 
