---
description: liste de documentation sur les Audiences Manager nouvelles et révisées publiée en 2016. Inclut des mises à jour mineures ou des modifications au guide d’Audience Manager qui pourraient ne pas être incluses dans les notes de mise à jour de l’Experience Cloud.
seo-description: liste de documentation sur les Audiences Manager nouvelles et révisées publiée en 2016. Inclut des mises à jour mineures ou des modifications au guide d’Audience Manager qui pourraient ne pas être incluses dans les notes de mise à jour de l’Experience Cloud.
...
liste de documentation sur les Audiences Manager nouvelles et révisées publiée en 2016. Inclut des mises à jour mineures ou des modifications au guide d’Audience Manager qui pourraient ne pas être incluses dans les notes de mise à jour de l’Experience Cloud.
...
<table id="table_D16570793032445FBC18F662BF9DDA7A"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../reporting/report-sampling.md"> Échantillonnage des données et taux d'erreur dans les rapports d'Audience Manager sélectionnés... </a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Inclut une nouvelle entrée sur les adresses IP et FTP <span class="keyword"> d’Audience Manager</span> répertoriées en blanc. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Documentation décrivant une nouvelle méthode DIL qui vous permet d’envoyer des données à <span class="keyword"> l’Audience Manager</span> à partir de Google Universal Analytics. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_D83514BA7F5745DA80D6135804D5BD5F"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <a href="../reference/visitor-authentication-states.md"> États d'authentification des Visiteurs dans l'Audience Manager </a> </td> 
   <td colname="col2"> <span class="keyword"> L’Audience Manager</span> traite les états d’authentification de l’ID de visiteur <code> UNKNOWN</code> et <code> LOGGED_OUT</code> de la même manière. Le document fournit plus d'informations sur la façon dont nous traitons les appels <code> setCustomerID</code> événements. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Reportez-vous à ce document pour obtenir une liste complète des identifiants d’ <span class="keyword"> Audience Manager</span> . </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_B19586DBA5D44F8E9D06610DB704EFB9"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2">Ajouté la capacité de sécuriser votre transfert de données sortantes en temps réel via le protocole OAuth 2.0. Contactez votre consultant <span class="keyword"> en Adobe Audience Manager</span> pour commencer. </td> 
  </tr> 
  <tr> 
...
<table id="table_9B18916DD43E4DB38C0C340DE4E3DF62"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <a href="https://docs.adobe.com/content/help/en/core-services/interface/ec-cookies/cookies-am.html" format="https" scope="external"> Cookies utilisés dans l’Experience Cloud</a> </td> 
   <td colname="col2"> Modification de la valeur de durée de vie (TTL) du cookie demdex et du cookie partenaire à 180 jours pour se conformer aux réglementations CNIL françaises. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> L’Audience Manager utilise l’heure universelle coordonnée (UTC) dans toute son interface utilisateur. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_50CD90671E4B4C50A624AC0948FA8324"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <a href="../features/traits/trait-device-targeting.md"> Ciblage de périphériques avec des clés de niveau Platform </a> </td> 
   <td colname="col2"> <p>Ajouté une liste téléchargeable des clés de périphérique les plus courantes, selon les mesures Device Atlas. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_E71252DF328F42A3AB0BD2CA7DC5A549"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Retiré de la documentation sur les <span class="keyword"> Audiences Manager</span> en septembre 2017. Déplacé vers la documentation <span class="keyword"> Analytics</span> . </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_BF1B40564C3C4B569A3B2504ACEEE0E4"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Décrit comment les fournisseurs de données <span class="wintitle"> d’Audience Marketplace</span> désactivent le flux d’un abonné. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md">Que se passe-t-il une fois qu’un fournisseur désactive mon flux de données ?</a> </p> </td> 
   <td colname="col2"> <p>Décrit ce à quoi un acheteur de données <span class="wintitle"> d’Audience Marketplace</span> peut s’attendre si un fournisseur révoque l’accès à un flux de données. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../api/dcs-intro/dcs-api-reference/dcs-error-codes.md"> Codes, messages et exemples d’erreur des serveurs de collecte de données </a> </p> </td> 
...
<table id="table_AC8FF0DB45B546C69D89749FF0FA1CCD"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../integration/media-data-integration/impression-data-pixels.md"> Capture des données d’impression de campagne via des appels de pixel </a> </p> </td> 
   <td colname="col2"> <p>Ajouté de nouvelles entrées de clé et de macro pour <code> d_mid</code> et <code> d_region</code>. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Nouvelle description Ajoutée pour le <span class="wintitle"> Type d'événement</span>. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Nouvelle documentation qui liste et définit les éléments dans un rapport de facturation <span class="wintitle"> d'Audience Marketplace</span> . </p> </td> 
  </tr> 
  <tr> 
