---
description: liste de la documentation sur Audience Manager, nouvelle et révisée, publiée en 2016. Inclut des mises à jour ou des modifications mineures du guide Audience Manager qui pourraient ne pas être incluses dans les notes de mise à jour d’Experience Cloud.
seo-description: liste de la documentation sur Audience Manager, nouvelle et révisée, publiée en 2016. Inclut des mises à jour ou des modifications mineures du guide Audience Manager qui pourraient ne pas être incluses dans les notes de mise à jour d’Experience Cloud.
seo-title: Mises à jour de la documentation de 2016
solution: Audience Manager
title: Mises à jour de la documentation de 2016
...
liste de la documentation sur Audience Manager, nouvelle et révisée, publiée en 2016. Inclut des mises à jour ou des modifications mineures du guide Audience Manager qui pourraient ne pas être incluses dans les notes de mise à jour d’Experience Cloud.
...
<table id="table_D16570793032445FBC18F662BF9DDA7A"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../reporting/report-sampling.md"> Echantillonnage de données et taux d'erreur dans les rapports Gestionnaire d'Audiences sélectionnés... </a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Après une mise à jour de Google en mai 2016, vous pouvez charger le code DIL dans la section HTML personnalisée d’une balise . Il n’est plus nécessaire d’héberger le code à distance. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../faq/faq-data-collection.md"> FAQ sur la collecte de données et l’intégration de produits </a> </p> </td> 
   <td colname="col2"> <p>Inclut une nouvelle entrée sur les adresses IP et FTP du gestionnaire <span class="keyword"> d’</span> Audiences qui répertorie les adresses blanches. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Documentation décrivant une nouvelle méthode DIL qui vous permet d’envoyer des données à <span class="keyword"> Audience Manager</span> à partir d’Analyses universelles de Google. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_D83514BA7F5745DA80D6135804D5BD5F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <span class="keyword"> Audience Manager</span> gère les états d’authentification de l’ID de visiteur <code> UNKNOWN</code> et <code> LOGGED_OUT</code> de la même manière. Le document fournit plus d'informations sur la façon dont nous traitons les appels <code> setCustomerID</code> événements. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Reportez-vous à ce document pour obtenir une liste complète des identifiants <span class="keyword"> Audience Manager</span> . </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Nouveau contenu qui décrit le fonctionnement des intervalles de temps pour les Audiences <span class="wintitle"></span> adressables et les <span class="wintitle"> Destinations</span>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Nouveau contenu qui décrit les fonctionnalités du landing page <span class="wintitle"> Destinations</span> . </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_B19586DBA5D44F8E9D06610DB704EFB9"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../reference/amazon-s3.md"> Amazon S3 : A propos </a> </p> </td> 
   <td colname="col2"> <p>Ajout du chiffrement au repos pour les transferts de données sortantes par lot. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Révision afin d’inclure plus d’informations sur la coopération <span class="keyword"> de périphériques d’</span>Adobe Experience Cloud. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_9B18916DD43E4DB38C0C340DE4E3DF62"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <a href="https://docs.adobe.com/content/help/en/core-services/interface/ec-cookies/cookies-am.html" format="https" scope="external"> Cookies utilisés dans Experience Cloud</a> </td> 
   <td colname="col2"> Modification de la valeur de durée de vie (TTL) du cookie demdex et du cookie partenaire à 180 jours pour se conformer aux réglementations CNIL françaises. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <a href="../dil/dil-overview.md"> Présentation de la bibliothèque d’intégration de données (DIL) </a> </td> 
   <td colname="col2">Présentation générale de la bibliothèque <span class="wintitle"> d’informations</span> de données (DIL). </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Audience Manager utilise l’heure universelle coordonnée (UTC) dans l’ensemble de son interface utilisateur. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../api/api-swagger-migration.md"> Migration du code d’API </a> </p> </td> 
   <td colname="col2"> <p>Ajout de liens vers les API Groupe de tests de segment et l’API de requête de flux de données. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_50CD90671E4B4C50A624AC0948FA8324"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <a href="../features/traits/trait-device-targeting.md"> Ciblage de périphériques avec clés au niveau de la plate-forme </a> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Contrôlez comment DIL effectue des appels de collecte de données avec HTTP ou HTTPS. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../faq/faq-api.md"> FAQ sur l’API </a> </p> </td> 
   <td colname="col2"> <p>Mise à jour du contenu expliquant pourquoi DIL utilise <code> GET</code> et <code> POST</code> des méthodes pour envoyer des données dans un appel de événement. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_183F245818BC4CF5AAB9B610C1BE4A9F"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <a href="../features/traits/trait-device-targeting.md"> Ciblage de périphériques avec clés au niveau de la plate-forme </a> </td> 
   <td colname="col2"> <p>Un nouveau document qui décrit les paires clé-valeur communes au niveau de la plate-forme que vous pouvez utiliser pour cible les utilisateurs avec des variables liées aux périphériques sur toutes les propriétés de votre compte Audience Manager. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_E71252DF328F42A3AB0BD2CA7DC5A549"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Retrait de la documentation de <span class="keyword"> Audience Manager</span> en septembre 2017. Déplacement vers la documentation <span class="keyword"> Analytics</span> . </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_106BAD4680F1446B813A907F9E3ADCB8"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> Versions d’ID de Visiteur Experience Cloud </p> </td> 
   <td colname="col2"> <p>Texte révisé pour les ID 1 et 2. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../features/profile-merge-rules/merge-rules-dashboard.md"> Tableau de bord de règles de fusion de Profil </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="https://docs.adobe.com/content/help/en/audience-manager/user-guide/implementation-integration-guides/integration-experience-platform/aam-aep-audience-sharing.html" format="https" scope="external"> Segments du Gestionnaire d’Audiences dans Analytics</a> </p> </td> 
...
<table id="table_D4EE56B5AE23497F98025E1D13CBB3A1"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Ajout d’un nouvel opérateur nommé <code> Matcheswords</code>. Vous permet de spécifier des modèles de mots correspondants sans utiliser d’expression régulière. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_BF1B40564C3C4B569A3B2504ACEEE0E4"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Décrit comment les fournisseurs de données <span class="wintitle"> Audience Marketplace</span> désactivent le flux d’un abonné. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md">Que se passe-t-il une fois qu’un fournisseur désactive mon flux de données ?</a> </p> </td> 
...
<table id="table_AC8FF0DB45B546C69D89749FF0FA1CCD"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../api/dcs-intro/dcs-s2s/dcs-s2s-calls.md"> Exécution d’appels d’API DCS serveur à serveur</a> </p> </td> 
   <td colname="col2" morerows="1"> <p>Révision du texte pour inclure la <code> d_mid</code> variable. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Ajout d’une nouvelle description du <span class="wintitle"> Type d'événement</span>. </p> </td> 
  </tr> 
  <tr> 
