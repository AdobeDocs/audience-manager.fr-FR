...
seo-title: Incidence de la Diffusion de données et des temps de traitement des fichiers sur les rapports
solution: Audience Manager
title: Incidence de la Diffusion de données et des temps de traitement des fichiers sur les rapports
...
# Incidence de la Diffusion de données et des temps de traitement des fichiers sur les rapports{#how-data-delivery-and-file-processing-times-affect-reports}
