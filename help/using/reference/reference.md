---
description: Contient une documentation technique sur la fonctionnalité du système, l'intégration des données et les fichiers d'aide.
seo-description: Contient une documentation technique sur la fonctionnalité du système, l'intégration des données et les fichiers d'aide.
seo-title: Référence
...
* [Environnement bêta](/help/using/reference/beta-environment.md)
* [Glossaire](/help/using/reference/aam-glossary.md)
* [Index des ID dans Audience Manager](/help/using/reference/ids-in-aam.md)
