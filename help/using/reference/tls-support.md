---
description: Transport Layer Security (TLS) est un protocole cryptographique utilisé pour établir un canal de communication sécurisé entre deux systèmes. Il est utilisé pour authentifier l’un ou les deux systèmes et protéger la confidentialité et l’intégrité des informations qui transitent entre les systèmes. En mai 2018, il y avait trois versions du protocole TLS en usage avec TLS 1.0, 1.1 et 1.2.
...
title: Obsolescence de TLS 1.0 et 1.1
...
# Obsolescence de TLS 1.0 et 1.1{#tls-deprecation}
...
En mars 2019, [!DNL Adobe] a mis fin au soutien au protocole de [!DNL TLS 1.0]. La fonctionnalité Adobe Audience Manager ne fonctionne pas pour vos utilisateurs finaux qui utilisent des navigateurs qui prennent uniquement en charge [!DNL TLS 1.0].

En mars 2020, [!DNL Adobe] cessera de soutenir le protocole de [!DNL TLS 1.1]. La fonctionnalité Adobe Audience Manager cessera de fonctionner pour vos utilisateurs finaux qui utilisent des navigateurs qui ne prennent en charge que le [!DNL TLS 1.1].

Adobe recommande vivement l’utilisation de [!DNL TLS 1.2], qui est, au moment de la rédaction de cet article, la dernière version du protocole. Tous les navigateurs modernes utilisent [!DNL TLS 1.2]. Nous avons rassemblé pour vous une liste de navigateurs, de versions et de leur prise en charge [!DNL TLS]. Pour plus d’informations sur la prise en charge du navigateur TLS, consultez [lien Wikipédia Transport Layer Security](https://en.wikipedia.org/wiki/Transport_Layer_Security#Web_browsers).
