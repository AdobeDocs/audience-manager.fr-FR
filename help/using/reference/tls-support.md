---
description: Transport Layer Security (TLS) est un protocole cryptographique utilisé pour établir un canal de communication sécurisé entre deux systèmes. Il est utilisé pour authentifier un ou les deux systèmes et protéger la confidentialité et l’intégrité des informations transmises entre les systèmes. En mai 2018, trois versions du protocole TLS utilisaient TLS 1.0, 1.1 et 1.2.
...
title: Obsolescence du protocole TLS 1.0 et 1.1
...
# Obsolescence du protocole TLS 1.0 et 1.1{#tls-deprecation}

Transport Layer Security (TLS) est un protocole cryptographique utilisé pour établir un canal de communication sécurisé entre deux systèmes. Il est utilisé pour authentifier un ou les deux systèmes et protéger la confidentialité et l’intégrité des informations transmises entre les systèmes. En mai 2018, trois versions du protocole TLS étaient en cours d’utilisation : TLS 1.0, 1.1 et 1.2.

En mars 2019, [!DNL Adobe] a arrêté la prise en charge du protocole [!DNL TLS 1.0]. La fonctionnalité de Adobe Audience Manager ne fonctionne pas pour les utilisateurs finaux qui utilisent des navigateurs qui prennent uniquement en charge [!DNL TLS 1.0].

En mars 2020, [!DNL Adobe] cessera de prendre en charge le protocole [!DNL TLS 1.1]. La fonctionnalité de Adobe Audience Manager cessera de fonctionner pour les utilisateurs finaux qui utilisent des navigateurs qui ne prennent en charge que [!DNL TLS 1.1].

Adobe recommande vivement l’utilisation de [!DNL TLS 1.2], qui est, au moment de la rédaction de cet article, la dernière version du protocole. Tous les navigateurs modernes utilisent [!DNL TLS 1.2]. Nous avons rassemblé pour vous une liste de navigateurs, de versions et leur prise en charge de [!DNL TLS]. Pour plus d’informations sur la prise en charge des navigateurs TLS, consultez le [lien Wikipédia Transport Layer Security](https://en.wikipedia.org/wiki/Transport_Layer_Security#Web_browsers).
