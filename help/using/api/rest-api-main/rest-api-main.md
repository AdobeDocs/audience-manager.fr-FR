...
TQID: https://experienceleague.adobe.com/TSYgffKqszvLSju464YHTKIqSBlmykqBsOgUd8iBcE4
...
Pour simplifier davantage votre travail, nous effectuons une migration de nos [!DNL REST APIs] vers [Swagger](https://swagger.io/solutions/api-documentation/). Pour plus d’informations, voir [Migration du code de l’API ](/help/using/api/api-swagger-migration.md).
